// AddStartExeToMSI.js <msi-file>
// Performs a post-build fixup of an MSI to add checkbox to allow launching a specific file
// https://blogs.msdn.microsoft.com/astebner/2006/08/12/mailbag-how-can-i-customize-an-msi-in-the-visual-studio-setupdeployment-project/

// Configurable values
var checkboxChecked = true;
var checkboxText = "Run [ProductName] now?";
var filename = "DisplaySwitch.exe";
...
catch(e){ WScript.StdErr.WriteLine(e); WScript.Quit(1); }
